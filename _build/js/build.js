...
var CommentList = _react2.default.createClass({
  ...
  render: function render() {
    var commentNodes = this.props.data.map(function (comment) {
      return _react2.default.createElement(
        Comment,
        { author: comment.author, key: comment.id, time: comment.time },
        comment.text
      );
    });
    return _react2.default.createElement(
...
_reactDom2.default.render(_react2.default.createElement(CommentBox, { url: 'api/messages', pollInterval: 2000 }), document.getElementById('mainContainer'));
